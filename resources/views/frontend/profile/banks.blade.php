...
.fp-bank-card { background:var(--card-dark);border:1px solid var(--card-border);border-radius:var(--radius);padding:24px;position:relative;isolation:isolate;transition:all 0.3s;height:100%;contain:layout style;min-width:0; }
