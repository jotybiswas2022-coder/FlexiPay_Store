...
<section class="fp-section">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <div class="section-badge"><i class="bi bi-geo-alt-fill"></i> Delivery Addresses</div>
                <h2 style="font-family:'Syne',sans-serif;font-size:28px;font-weight:800;color:var(--text-primary);">My Addresses</h2>
            </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="fp-address-card {{ $address->is_default ? 'default' : '' }}">
                    ...
                    <div class="fp-addr-actions">
                        <a href="{{ route('profile.addresses.update', $address) }}" class="fp-addr-btn edit" data-bs-toggle="modal" data-bs-target="#editAddress{{ $address->id }}"><i class="bi bi-pencil-fill"></i></a>
            ...
            <form method="POST" action="{{ route('profile.addresses.store') }}">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <input type="text" name="state" class="fp-input" placeholder="State" required>
                        </div>
                        <div class="col-12">
...
.fp-address-card:hover { border-color: rgba(234,179,8,0.2); }
...
.fp-addr-btn { width: 34px; height: 34px; border-radius: 6px; display: flex; align-items: center; justify-content: center; border: 1px solid var(--card-border); color: var(--text-dim); font-size: 14px; transition: all 0.2s; }
