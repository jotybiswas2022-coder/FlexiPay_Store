...
@section('content')
<section class="fp-profile-section">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3">
                <div class="fp-profile-sidebar">
                    ...
                    <nav class="fp-profile-nav">
                        <a href="{{ route('profile.index') }}" class="active"><i class="bi bi-person-fill"></i> Profile</a>
            ...
            <div class="col-lg-9">
                ...
                <!-- Recent Orders -->
                <div class="fp-profile-card mt-4">
                    <div class="fp-profile-card-header">
...
.fp-avatar-email { color: var(--text-dim); font-size: 12px; }
...
.fp-order-status-badge.processing { background: rgba(234,179,8,0.15); color: var(--gold-400); }
