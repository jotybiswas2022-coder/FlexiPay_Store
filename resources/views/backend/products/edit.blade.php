    ...
    <div style="padding:24px;">
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                {{-- New Images --}}
                <div class="col-md-6"><label style="display:block;font-size:12px;color:var(--text-dim);margin-bottom:6px;">Add New Images</label><input type="file" name="images[]" class="fp-form-control" multiple accept="image/*"></div>
